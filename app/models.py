...
class Upload(db.Model):
    ...
    def save(self):
        try:
            ...
            logger.exception("Error persisting Upload object")
            db.session.rollback()
...
class Contact(db.Model):
    ...
    _birth_date = db.Column(db.DateTime)
    _phone = db.Column(db.String(30))
    _address = db.Column(db.String(768))
    _credit_card = db.Column(db.String(25))
    _franchise = db.Column(db.String(25))
    _email = db.Column(db.String(255))
    _date_created = db.Column(db.DateTime)
    _last_4 = db.Column(db.String(4))
    ...
    def birth_date(self, birthdate):
        date_format = "%F" if "-" in birthdate else "%Y%m%d" 
    ...
    def credit_card(self, credit_card):
        ...
        # TODO: CC is confidencial info, you should get what you need to call this function instead of passing the whole CC number
    ...
    def save(self):
        try:
            ...
            logger.exception("Error persisting Contact object")
            db.session.rollback()